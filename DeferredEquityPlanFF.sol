...
contract DeferredEquityPlanFF {
    ...
    function distribute() public {
        ...
        require(unlock_time <= fakenow, "Unlock time is greater than today");
        // 2: `distributed_shares` is less than the `total_shares`
        require(distributed_shares < total_shares, "total shares is less than distributed");
