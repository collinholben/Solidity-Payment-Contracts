...
contract DeferredEquityPlan {
    ...
    function distribute() public {
        ...
        require(unlock_time <= now, "unlock time is not less than or equal to now");
        
        // 2: `distributed_shares` is less than the `total_shares`
        require(distributed_shares < total_shares, "total_shares is less than distributed shares"); 
        ...
        distributed_shares = ((now - start_time / 365) * annaul_distribution);
